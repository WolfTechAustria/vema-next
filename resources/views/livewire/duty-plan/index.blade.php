{{--
    Wichtig: @include darf nicht VOR diesem einzigen äußeren <div> stehen.
    Livewire braucht pro Komponente ein stabiles Root-Element — stünde hier
    ein Geschwister-Element vor diesem <div>, würde bei einer erfolgreichen
    Aktion (z. B. neuer Dienstplan, automatische Einteilung) plötzlich dieses
    Geschwister-Element zum Root-Element, was Livewires DOM-Abgleich
    verwirrt und dazu führt, dass der Rest der Seite nach der Aktion leer
    bleibt, bis man neu lädt.
--}}
<div class="space-y-6">
